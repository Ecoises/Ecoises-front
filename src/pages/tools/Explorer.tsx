...
export default function Explorer() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-lime-50 via-white to-emerald-50 p-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 bg-white rounded-xl border-lime-200 h-12"
              value={searchTerm}
          ...
          <Button 
            variant="outline" 
            className="md:w-auto border-lime-200 gap-2 rounded-xl h-12"
